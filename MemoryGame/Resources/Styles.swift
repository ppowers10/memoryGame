...
struct Styles {
    ...
    struct Font {
        static let large = UIFont(name: "ChalkboardSE-Regular", size: 38)!
        static let medium = UIFont(name: "ChalkboardSE-Regular", size: 32)!
    }
    
    struct Color {
        static let headerOrange = UIColor(red:1.00, green:0.60, blue:0.00, alpha:1.0)
        static let titleRed = UIColor(red:1.00, green:0.60, blue:0.00, alpha:1.0)
